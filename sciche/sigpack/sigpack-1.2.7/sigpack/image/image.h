...
public:
    ...
    void read_header()
    {
        ...
        while (ifs >> str) // Read until we have maxval
        {
            ...
            if (type == NOTUSED) {
                ...
                if (str.at(0) != 'P' || type > PPM_B)
                    err_handler("Wrong type!");
            }
            else if (cols == 0) {
                cols = atoi(str.c_str());
            }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////
    void write_header(const imtype _type, const arma::uword _rows, const arma::uword _cols, const int _maxval,
            ...
            if (type == PPM_A) // Plain (ASCII )type
            {
                for (arma::uword r = 0; r < rows; r++) {
                    ...
                    for (arma::uword c = 0; c < cols; c++) {
                        ...
                        if (++i % 5 == 0)
                            ofs << std::endl; // Max len is 70 chars/line
                    }
                }
            }
            else if (type == PPM_B) {
