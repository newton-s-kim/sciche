...
//                                      'freqz','phasez'
//  1.0.4	Claes Rolén		2015-08-01	Added FFTW class, 'unwrap', 'update_coeffs' + commenting for
//  Doxygen 1.0.5	Claes Rolén		2015-10-11	Added plot to file in gplot 1.0.6	Claes Rolén
//  2015-12-30	Added support for importing/exporting Wisdom in FFTW 1.0.7	Claes Rolén		2016-10-20
//  Added support for FFTW 2-D and simple image I/O 1.0.8   Claes Rolén     2016-11-15  Added adaptive filters - LMS,
//  N-LMS and RLS. New line plot function of matrix data. 1.1.1   Claes Rolén     2017-01-20  Cleanup, added Kalman and
//  Newton adaptive filters 1.1.2   Claes Rolén     2017-03-07  Added Kalman tracking and control 1.2.1   Claes Rolén
//  2017-03-13  Updated for Gnuplot 5.0, plot(..) changes to plot_add(..) plus plot_show() 1.2.2   Claes Rolén
//  2017-07-13  Added EKF and UKF classes, Non class functions set to arma_inline. 1.2.3   Claes Rolén     2017-08-08
//  Updated FIR design functions, support for highpass, bandpass and bandstop. 1.2.4   Claes Rolén     2018-03-17
//  Updated resampling class, added goertzel and timevec functions. 1.2.5   Claes Rolén     2019-01-04  Removed warnings
//  in Visual Studio. Bug fix in PNM class write_header().
...
/// If gplot module is used you will need Gnuplot version 5 or higher.
